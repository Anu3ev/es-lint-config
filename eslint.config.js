...
/**
 * Shared ESLint flat config for Fabric image editor projects.
 *
 * @param {object} [options]
 * @param {string} [options.tsconfigPath] Relative path to the TS config file.
 * @param {string} [options.tsconfigRootDir] Directory used to resolve the TS config.
 * @returns {import('eslint').Linter.Config[]}
 */
export default function createFabricImageEditorEslintConfig(options = {}) {
  const { tsconfigPath, tsconfigRootDir } = { ...defaultOptions, ...options }
